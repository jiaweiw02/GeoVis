...
\begin{abstract}
    ...
    change. To compile this project, we utilized datasets from \href{https://www.kaggle.com/datasets}{Kaggle} and NOAA \cite{noaa_2019_national}.
...
leverages ones ability to understand climate change. Creating a map visualization was what we believed to be the most intuitive way to visualize data, we were inspired by wind fm \cite{a2019_wind} and \cite{beccario_2019_earth} earth nullschool.
